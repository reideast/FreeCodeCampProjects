...
router.add("POST", /^\/talks\/([^\/]+)\/comments$/, // this time, the regex will only match when followed by "/comments"
  function(request, response, title) {
...
function waitForChanges(since, response) {
  ...
  waiting.push(waiter);
  setTimeout(function() { // after a 90 sec. timeout, remove the waiting item if it's still there
